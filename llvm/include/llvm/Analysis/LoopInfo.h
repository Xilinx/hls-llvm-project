...
public:
  ...
  /// Stores the loop induction variables or the auxiliary induction variables
  /// in \p IndVars if found.
  /// An instruction is considered as the loop induction variable if
  /// - it is an induction variable of the loop; and
  /// - it is used to determine the condition of the branch in the loop latch
  ///
  /// An instruction is considered as the auxiliary induction variable if
  /// - in the loop header
  ...
  ///
  /// Note:
  /// - the induction variable doesn't need to be canonical, i.e. starts at
  ///   zero and increments by one each time through the loop (but it can be).
  /// - auxiliary induction variable is not required to be used in the
  ///   conditional branch in the loop latch. (but it can be)
  void getAllInductionVariables(ScalarEvolution &SE,
